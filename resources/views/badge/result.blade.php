  ...
  <div class="result-card">
    ...
    <div class="shift-grid">
      ...
      <div class="shift-cell">
        ...
        <div class="shift-cell-value total-heures">{{ $todayShift['total_human'] ?? '—' }}</div>
      </div>
    </div>

    @if(!empty($todayShift['pause_display']))
    <div class="divider"></div>
    <div class="shift-grid">
      <div class="shift-cell">
        <div class="shift-cell-label">⏸ Début pause</div>
        <div class="shift-cell-value">{{ $todayShift['pause_start'] ?? '—' }}</div>
      </div>
      <div class="shift-cell">
        <div class="shift-cell-label">↩ Retour</div>
        <div class="shift-cell-value">{{ $todayShift['pause_end'] ?? '—' }}</div>
      </div>
      <div class="shift-cell">
        <div class="shift-cell-label">⏱ Durée pause</div>
        <div class="shift-cell-value total-heures">{{ $todayShift['total_pause_human'] ?? '—' }}</div>
      </div>
    </div>
    @endif
