                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($ab->status == 'approved') <span class="badge badge-success">Approuvé</span>
                                    @elseif($ab->status == 'pending') <span class="badge badge-warning">En attente</span>
                                    @elseif($ab->status == 'rejected') <span class="badge badge-danger">Rejeté</span>
                                    @else <span class="badge badge-neutral">Annulé</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
