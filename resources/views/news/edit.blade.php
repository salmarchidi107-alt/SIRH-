            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="4">{{ $news->description }}</textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="image-upload-area" onclick="document.getElementById('image').click()">
                            @if($news->image)
                                <div id="image-preview-container">
                                    <img id="image-preview" src="{{ asset($news->image) }}" alt="Preview" style="max-width:100%;max-height:200px;border-radius:8px;">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control" required>
                            @foreach(\App\Models\News::TYPES as $key => $label)
                                <option value="{{ $key }}" {{ $news->type === $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="event_date" id="event_date" class="form-control" value="{{ $news->event_date->format('Y-m-d') }}" required>
                    </div>
                </div>
            </div>
