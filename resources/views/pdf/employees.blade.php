  ...
  <tbody>
    @forelse($employees as $emp)
      ...
      <tr>
        ...
        <td>{{ $emp->phone ?? '—' }}</td>
        <td>
          @php $s = $emp->status ?? 'active'; @endphp
          <span class="pill {{ $s === 'active' ? 'pill-active' : ($s === 'leave' ? 'pill-leave' : 'pill-inactive') }}">
            {{ $s === 'active' ? 'Actif' : ($s === 'leave' ? 'Congé' : 'Inactif') }}
          </span>
        </td>
      </tr>
