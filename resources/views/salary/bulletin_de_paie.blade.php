...
@php
    ...
    $fp_label  = $cur === 'MRU' ? ''      : 'Frais professionnels';
...
<div class="bulletin-paie">
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:center;">{{ ucfirst($emp->family_status ?? 'Célibataire') }}</td>
    ...
    <table class="table-lignes">
        ...
        <tbody>
            ...
            <tr>
                <td class="col-libelle">Cotisation {{ $cur === 'MRU' ? 'CNSS' : 'CNSS' }}</td>
