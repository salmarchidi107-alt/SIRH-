            ...
            <div style="display:grid;gap:16px;max-width:600px">
                ...
                <div>
                    ...
                    <select name="template_id" required style="width:100%;padding:10px 12px;border:1px solid var(--border);border-radius:8px;font-size:0.9rem;background:white">
                        ...
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($t->id); ?>" <?php echo e(request('template_id') == $t->id ? 'selected' : ''); ?>>
                                <?php echo e($t->name); ?>
                ...
                <div>
                    <label style="display:block;margin-bottom:6px;font-weight:600;font-size:0.875rem">
                        <?php echo e($template && $template->department ? 'Département ciblé' : 'Employé / Département'); ?>

                    </label>
                    <?php if($template && $template->department): ?>
                        
                        <div style="padding:12px;background:var(--surface-2);border-radius:8px;border:1px solid var(--border);font-weight:500">
                            📍 <?php echo e($template->department); ?>

                            <span style="font-size:0.85rem;color:var(--text-muted);font-weight:400">
                                (<?php echo e(\App\Models\Employee::where('department', $template->department)->where('status', 'active')->count()); ?> employés)
                            </span>
                            <input type="hidden" name="department_target" value="<?php echo e($template->department); ?>">
                        </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/planning/templates/apply.blade.php ENDPATH**/ ?>