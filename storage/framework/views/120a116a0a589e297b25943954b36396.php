...
<div class="card mb-4">
    <div class="card-body" style="padding:14px 20px">
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;font-size:0.85rem">
            ...
            <div><div style="color:var(--text-muted);font-size:0.75rem">Date d'embauche</div><strong><?php echo e($employee->hire_date ? \Carbon\Carbon::parse($employee->hire_date)->format('d/m/Y') : '—'); ?></strong></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/salary/show.blade.php ENDPATH**/ ?>