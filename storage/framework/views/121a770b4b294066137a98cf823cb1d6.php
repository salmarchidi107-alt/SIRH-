...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'HospitalRH'); ?> — HospitalRH</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="<?php echo e(route('dashboard')); ?>" class="brand">
                <div class="brand-icon"><i class="fa-solid fa-hospital" aria-hidden="true"></i></div>
        ...
        <nav class="sidebar-nav">
            ...
            <?php if(Auth::user() && Auth::user()->role === 'employee'): ?>
            ...
            <?php if(Auth::user() && in_array(Auth::user()->role, ['admin', 'rh'])): ?>
            ...
            <a href="<?php echo e(route('trombinoscope')); ?>" class="nav-item <?php echo e(request()->routeIs('trombinoscope') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('news.index')); ?>" class="nav-item <?php echo e(request()->routeIs('news.*') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('planning.show', ['employee' => Auth::user()->employee_id ?? 0])); ?>" class="nav-item <?php echo e(request()->routeIs('planning.show') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('planning.weekly')); ?>" class="nav-item <?php echo e(request()->routeIs('planning.*') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                    <line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/>
                    <line x1="3" y1="10" x2="21" y2="10"/>
            ...
            <a href="<?php echo e(route('temps.vue-ensemble')); ?>" class="nav-item <?php echo e(request()->routeIs('temps.vue-ensemble') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('absences.index')); ?>" class="nav-item <?php echo e(request()->routeIs('absences.index') || request()->routeIs('absences.show') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <?php if(Auth::user() && in_array(Auth::user()->role, ['admin', 'rh'])): ?>
            <a href="<?php echo e(route('absences.calendar')); ?>" class="nav-item <?php echo e(request()->routeIs('absences.calendar') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                    <line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/>
                    <line x1="3" y1="10" x2="21" y2="10"/>
            ...
            <?php if(Auth::user() && in_array(Auth::user()->role, ['admin', 'rh'])): ?>
            <a href="<?php echo e(route('absences.counters')); ?>" class="nav-item <?php echo e(request()->routeIs('absences.counters') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="<?php echo e(route('pointage.index')); ?>"
       ...
       style="display:flex;align-items:center;gap:10px;">
        ...
        <?php if($pointageEnAttente > 0): ?>
            <span class="badge"><?php echo e($pointageEnAttente); ?></span>
        <?php endif; ?> 
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('salary.index')); ?>" class="nav-item <?php echo e(request()->routeIs('salary.*') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
                </svg>
                Salaires
                <a href="<?php echo e(route('salary.index')); ?>" class="nav-link">
    Paie
</a>
<a href="<?php echo e(route('variables.index')); ?>" class="nav-link">
    Éléments variables
</a>
            </a>
            <?php endif; ?>
            ...
            <?php if(Auth::user() && Auth::user()->role === 'employee' && Auth::user()->employee_id): ?>
            <div class="nav-section-label">Paie</div>
            <a href="<?php echo e(route('salary.show', Auth::user()->employee_id)); ?>" class="nav-item <?php echo e(request()->routeIs('salary.show') ? 'active' : ''); ?>">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
                </svg>
                Mon Salaire
        ...
        <div class="sidebar-footer">
            ...
            <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-outline w-100" style="color: #fff; border-color: rgba(255,255,255,0.3); display: flex; align-items: center; justify-content: center; gap: 8px; padding: 8px;">
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="topbar-actions">
                <div class="notification-wrapper" style="position: relative;">
                    ...
                    <div class="notification-dropdown" id="notifDropdown" style="display: none; position: absolute; top: 100%; right: 0; width: 320px; background: white; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); z-index: 1000; margin-top: 8px; max-height: 400px; overflow-y: auto;">
                        ...
                        <div style="padding: 8px 16px; border-top: 1px solid #eee; text-align: center;">
                            <a href="<?php echo e(route('notifications.index')); ?>" style="font-size: 0.8rem; color: var(--primary); text-decoration: none;">Voir toutes les notifications</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="export-wrapper" style="position: relative;">
                    ...
                    <div class="export-dropdown" id="exportDropdown" style="display: none; position: absolute; top: 100%; right: 0; width: 280px; background: white; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); z-index: 1000; margin-top: 8px; max-height: 400px; overflow-y: auto;">
                        ...
                        <a href="<?php echo e(route('employees.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Liste du Personnel
                        </a>
                        <a href="<?php echo e(route('trombinoscope.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Trombinoscope
                        </a>
                        ...
                        <a href="<?php echo e(route('absences.droits.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Droits d'Absences
                        </a>
                        <a href="<?php echo e(route('absences.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Demandes d'Absences
                        </a>
                        <a href="<?php echo e(route('absences.counters.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Compteurs Absences
                        </a>
                        <a href="<?php echo e(route('absences.droits.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Droits d'Absences
                        </a>
<a href="<?php echo e(route('planning.monthly.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                              Planning Mensuel
                        </a>
                        <a href="<?php echo e(route('planning.weekly.export')); ?>" style="display: block; padding: 12px 16px; text-decoration: none; color: inherit; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
        ...
        <main class="page-content">
            ...
            <?php if(session('warning')): ?>
                <div class="alert alert-warning"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i> <?php echo e(session('warning')); ?></div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\HP\SI_RH\resources\views/layouts/app.blade.php ENDPATH**/ ?>