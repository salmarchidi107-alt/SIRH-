...
<div class="container-fluid py-4 px-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        <a href="<?php echo e(route('ged.index')); ?>" style="color:#64748b;font-size:13px;text-decoration:none;">
            <i class="fas fa-folder-open me-1"></i>Documents
        </a>
        <span style="color:#cbd5e1;">›</span>
        <span style="color:#0d2238;font-size:13px;font-weight:600;"><?php echo e($document->nom); ?></span>
    </div>
                        ...
                        <div>
                            ...
                            <div class="ged-select-wrap">
                                <select name="modele_id" class="ged-select" id="selectModele" required>
                                    ...
                                    <?php $__currentLoopData = $modeles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($mod->id); ?>"
                                            <?php echo e(old('modele_id', $document->modele_id) == $mod->id ? 'selected' : ''); ?>>
                                            <?php echo e($mod->nom); ?>
...
<script>
// ── Données PHP → JS ──────────────────────────────────────────────────────────
const contenuDocument   = atob(<?php echo json_encode($contenuInitial, 15, 512) ?>);
const modelesContenuB64 = <?php echo json_encode($modelesContenu, 15, 512) ?>;
const employesData      = <?php echo json_encode($employesJson, 15, 512) ?>;
const tenantData        = <?php echo json_encode($tenantJson, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SIRH-\resources\views/ged/edit.blade.php ENDPATH**/ ?>