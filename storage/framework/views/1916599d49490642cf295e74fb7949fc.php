...
<div class="result-inner">
  ...
  <div class="icon-area">
    <div class="ripple" style="background:<?php echo e($ripple); ?>;"></div>
    <div class="ripple" style="background:<?php echo e($ripple); ?>;"></div>
    <div class="icon-box" style="background:<?php echo e($iconBg); ?>;box-shadow:0 16px 48px <?php echo e($ripple); ?>;">
      <?php echo e($typeIcon); ?>
  ...
  <div class="result-card">
    ...
    <div class="type-badge"
         style="background:<?php echo e($badgeBg); ?>;border:1px solid <?php echo e($badgeBorder); ?>;color:<?php echo e($textColor); ?>;">
    ...
    <?php if($employee): ?>
      ...
      <div class="emp-dept"><?php echo e($employee->department ?? '—'); ?> · <?php echo e($employee->matricule ?? 'N/A'); ?></div>
    <?php else: ?>
      <div class="emp-name">—</div><div class="emp-dept">—</div>
    <?php endif; ?>

    <div class="time-lbl"><?php echo e($timeLabel); ?></div>
    <div class="time-big" style="color:<?php echo e($textColor); ?>;"><?php echo e($displayTime); ?></div>
    <div class="time-date"><?php echo e($dateFr); ?></div>
    ...
    <div class="sg">
      <div class="sc">
        ...
        <div class="sc-val c-teal"><?php echo e($todayShift['first_entree'] ?? '—'); ?></div>
      </div>
      <div class="sc">
        <div class="sc-lbl">📤 Sortie</div>
        <div class="sc-val c-amber"><?php echo e($todayShift['last_sortie'] ?? '—'); ?></div>
      </div>
      <div class="sc">
        <div class="sc-lbl">⏱ Total</div>
        <div class="sc-val" style="color:var(--green);"><?php echo e($todayShift['total_human'] ?? '0h 0m'); ?></div>
      </div>
    </div>
    ...
    <div class="sg">
      <div class="sc">
        ...
        <div class="sc-val" style="color:#818cf8;"><?php echo e($todayShift['pause_start'] ?? '—'); ?></div>
      </div>
      <div class="sc">
        <div class="sc-lbl">↩ Retour</div>
        <div class="sc-val c-green"><?php echo e($todayShift['pause_end'] ?? '—'); ?></div>
      </div>
      <div class="sc">
        <div class="sc-lbl">⏱ Pause</div>
        <div class="sc-val c-amber"><?php echo e($todayShift['total_pause_human'] ?? '0m'); ?></div>
      </div>
    </div>
    <?php endif; ?>
    ...
    <div class="geo-block">
      ...
      <div class="geo-map-wrap">
        ...
        <?php if($geoAcc): ?>
          <div class="map-badge-acc" style="color:<?php echo e($geoHigh ? '#86efac' : '#fde68a'); ?>;">
            ± <?php echo e($geoAcc); ?> m
          </div>
        <?php endif; ?>
      </div>
      ...
      <div class="geo-addr">
        ...
        <div style="flex:1; min-width:0;">
          ...
          <div class="geo-addr-val">
            ...
            <?php else: ?>
              <?php echo e($geoLat); ?>° N, <?php echo e($geoLngSign); ?><?php echo e($geoLng); ?>° <?php echo e($geoHem); ?>

              <?php if($geoAcc): ?>
                <span style="font-size:11px;opacity:.5;"> · ±<?php echo e($geoAcc); ?> m</span>
              <?php endif; ?>
            <?php endif; ?>
          </div>
        </div>
      ...
      <div class="geo-footer">
        <span>Localisé à <?php echo e($geoTs); ?></span>
      </div>
...
<script>
(function () {
  var lat = <?php echo e((float)$geo['latitude']); ?>;
  var lng = <?php echo e((float)$geo['longitude']); ?>;
  var acc = <?php echo e($geoAcc ?? 60); ?>;
...
(function(){
  ...
  const t  = setInterval(() => {
    ...
    if (s <= 0) { clearInterval(t); window.location.href = '<?php echo e(route('badge.pointage')); ?>'; }
  }, 1000);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.badge', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/badge/result.blade.php ENDPATH**/ ?>