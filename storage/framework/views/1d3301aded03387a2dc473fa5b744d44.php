                ...
                <tbody>
                    <tr style="border-bottom:1px solid var(--border-color)">
                        <td style="padding:9px 14px">
                            ...
                            <div style="font-size:0.75rem;color:var(--text-muted)" id="absence-sub">(Brut / <span id="heures-ref-label">191,25</span> h) × <?php echo e($workingData['absence_hours'] ?? 0); ?> h = calculé auto</div>
                        </td>
