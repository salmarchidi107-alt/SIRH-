...
<head>
    ...
    <title>Vérification de sécurité — <?php echo e($name ?? 'Vérification'); ?></title>
            ...
            <div class="auth-brand">
                <div class="auth-brand-icon">
                    <?php if(isset($tenantData['logo_path']) && $tenantData['logo_path']): ?>
                        <img src="<?php echo e(asset('storage/' . $tenantData['logo_path'])); ?>"
                             alt="<?php echo e($tenantData['name'] ?? 'Logo'); ?>" class="auth-logo-img">
                    <?php else: ?>
                ...
                <div class="auth-brand-name"><?php echo e($tenantData['name'] ?? 'Vérification'); ?></div>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('2fa.verify')); ?>" autocomplete="off" id="otp-form">
                ...
                <div class="otp-digits">
                    <?php for($i = 0; $i < 6; $i++): ?>
                        <input
                            type="text"
                            class="otp-digit <?php echo e($errors->has('code') ? 'has-error' : ''); ?>"
                            maxlength="1"
                            inputmode="numeric"
                            pattern="[0-9]"
...
<?php /**PATH C:\Users\HP\SIRH-v2\resources\views/auth/otp.blade.php ENDPATH**/ ?>