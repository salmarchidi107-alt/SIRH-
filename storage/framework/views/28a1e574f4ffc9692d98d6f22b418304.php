...
<head>
    ...
    <title>Super Admin — <?php echo $__env->yieldContent('title', 'SuperAdmin'); ?></title>
    <style>
    /* ═══════════════════════════════════════════════════════════════════════
       RESET & BASE
    ═══════════════════════════════════════════════════════════════════════ */
    ...
    <aside class="sa-sidebar">
        ...
        <div class="sa-nav">
            ...
            <a href="<?php echo e(route('superadmin.dashboard')); ?>"
               class="sa-item <?php echo e(request()->routeIs('superadmin.dashboard') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('superadmin.tenants.index')); ?>"
               class="sa-item <?php echo e(request()->routeIs('superadmin.tenants*') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('superadmin.tenants.create')); ?>"
               class="sa-item <?php echo e(request()->routeIs('superadmin.tenants.create') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('superadmin.clients.index')); ?>"
               class="sa-item <?php echo e(request()->routeIs('superadmin.clients*') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?php echo e(route('superadmin.roles.index')); ?>"
               class="sa-item <?php echo e(request()->routeIs('superadmin.roles*') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<a href="<?php echo e(route('superadmin.codes.index')); ?>"
   class="sa-item <?php echo e(request()->routeIs('superadmin.codes*') ? 'active' : ''); ?>">
    ...
    Codes de vérification
        ...
        <div class="sa-footer">
            <div class="sa-user">
                <div class="sa-avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'SA', 0, 2))); ?></div>
                <div>
                    <div class="sa-user-namee"><?php echo e(auth()->user()->name ?? 'Super Admin'); ?></div>
                </div>
            </div>
    ...
    <div class="sa-main">
        ...
        <div class="sa-topbar">
            <div class="sa-topbar-title"><?php echo $__env->yieldContent('page-title', 'Gestion des Accès'); ?></div>
        ...
        <div class="sa-flash warning">⚠ <?php echo e(session('warning')); ?></div>
        <?php endif; ?>

        
        <div class="sa-content">
            <div class="sa-page-header">
                <div><?php echo $__env->yieldContent('page-header'); ?></div>
...
<?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/layouts/superadmin.blade.php ENDPATH**/ ?>