<?php $__env->startSection('title', 'Connexion — Pointage'); ?>
...
<div class="login-wrap">
  <div class="login-card">
    ...
    <div class="login-title">
      <h2><?php echo e($action === 'entree' ? 'Pointage Entrée' : 'Pointage Sortie'); ?></h2>
    ...
    <form method="POST" action="<?php echo e(route('badge.auth.validate')); ?>" id="authForm">
      <?php echo csrf_field(); ?>
<input type="hidden" name="action" value="<?php echo e($action); ?>">
    ...
    <div class="login-footer">
      <a href="<?php echo e(url('/')); ?>">← Retour à l'espace admin</a>
    </div>
  </div>
</div>
...
<?php echo $__env->make('layouts.badge', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/badge/login.blade.php ENDPATH**/ ?>