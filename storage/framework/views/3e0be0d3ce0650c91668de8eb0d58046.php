                    ...
                    <tr>
                        ...
                        <td class="py-3 px-4" style="white-space:nowrap;">
                            <div style="display:flex;flex-direction:row;align-items:center;gap:6px;flex-wrap:nowrap;">
                                <a href="<?php echo e(route('ged.modeles.edit', $modele)); ?>"
                                   title="Modifier"
    ...
    <div class="d-flex justify-content-end">
        <nav>
            <ul class="pagination mb-0" style="list-style:none;padding-left:0;">
                <?php if($modeles->onFirstPage()): ?>
                    <li class="page-item disabled"><span class="page-link">&laquo;</span></li>
                <?php else: ?>
                    <li class="page-item"><a class="page-link" href="<?php echo e($modeles->previousPageUrl()); ?>">&laquo;</a></li>
                <?php endif; ?>

                <?php $__currentLoopData = $modeles->getUrlRange(1, $modeles->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="page-item <?php echo e($page == $modeles->currentPage() ? 'active' : ''); ?>">
                        <a class="page-link" href="<?php echo e($url); ?>"><?php echo e($page); ?></a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php if($modeles->hasMorePages()): ?>
                    <li class="page-item"><a class="page-link" href="<?php echo e($modeles->nextPageUrl()); ?>">&raquo;</a></li>
                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\SIRH-\resources\views/ged/modeles.blade.php ENDPATH**/ ?>