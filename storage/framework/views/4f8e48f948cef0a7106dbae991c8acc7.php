...
<div class="lms-page">
    ...
    <form method="GET" action="<?php echo e(route('lms.index')); ?>" class="lms-toolbar">
        <div class="lms-search">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Rechercher employé ou formation...">
        </div>
        <select name="departement_id" class="lms-sel" onchange="this.form.submit()">
            <option value="">Tous les services</option>
            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($dept->id); ?>" <?php echo e(request('departement_id') == $dept->id ? 'selected' : ''); ?>><?php echo e($dept->name); ?></option>
        ...
        <select name="statut" class="lms-sel" onchange="this.form.submit()">
            ...
            <?php $__currentLoopData = \App\Models\Formation::STATUTS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($s); ?>" <?php echo e(request('statut') === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <?php if(request()->hasAny(['search','departement_id','formation','statut'])): ?>
            <a href="<?php echo e(route('lms.index')); ?>" class="btn-lms btn-lms-ghost" style="padding:7px 12px;">
                ...
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:10px;">
                            <div class="lms-av" style="background:<?php echo e($c[1]); ?>;color:<?php echo e($c[0]); ?>;"><?php echo e($ini); ?></div>
                            <div>
                                <div style="font-weight:500;"><?php echo e($full); ?></div>
                                <div style="font-size:11px;color:#9ca3af;margin-top:1px;"><?php echo e($dept); ?></div>
                            </div>
                        </div>
                    </td>
                    <td style="font-weight:500;"><?php echo e($f->titre); ?></td>
                    <td style="color:#6b7280;"><?php echo e($f->formateur); ?></td>
                    <td style="color:#6b7280;"><?php echo e($f->organisme); ?></td>
                    ...
                    <td>
                        <div style="display:flex;gap:6px;">
                            <button class="lms-act" title="Modifier"
                                    onclick='editFormation(<?php echo json_encode($f->load("employee"), 15, 512) ?>)'>
                                <i class="fas fa-pen" style="font-size:11px;"></i>
                            </button>
                            <form action="<?php echo e(route('lms.destroy', $f)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\khawl\SIRH-\resources\views/lms/index.blade.php ENDPATH**/ ?>