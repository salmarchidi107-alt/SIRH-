...
<div class="sa-field">
    ...
    <select name="timezone" class="sa-input" required>
        <?php
            ...
            $selectedTz = old('timezone', 'Africa/Casablanca');
        ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/superadmin/tenants/create.blade.php ENDPATH**/ ?>