        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:16px">
            <div class="salary-card" style="padding:12px 16px">
                ...
                <div class="salary-net bonus" style="font-size:1.3rem">
                    +<?php echo e(number_format($elements->where('category','gain')->sum('amount'),0,',',' ')); ?> MAD
                </div>
                <div style="font-size:0.75rem;opacity:0.6"><?php echo e($elements->where('category','gain')->count()); ?> éléments</div>
            </div>
            <div class="salary-card" style="padding:12px 16px">
                <div class="salary-label">Total retenues ajoutées</div>
                <div class="salary-net deduction" style="font-size:1.3rem">
                    -<?php echo e(number_format($elements->where('category','retenue')->sum('amount'),0,',',' ')); ?> MAD
                </div>
                <div style="font-size:0.75rem;opacity:0.6"><?php echo e($elements->where('category','retenue')->count()); ?> éléments</div>
            </div>
            <div class="salary-card" style="padding:12px 16px">
                <div class="salary-label">Impact net sur la paie</div>
                <div class="salary-net" style="font-size:1.3rem">
                    <?php echo e(number_format($elements->where('category','gain')->sum('amount') - $elements->where('category','retenue')->sum('amount'),0,',',' ')); ?> MAD
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-<?php echo e($el->category === 'gain' ? 'success' : 'danger'); ?>">
                                        <?php echo e($el->category === 'gain' ? 'Gain' : 'Retenue'); ?>

                                    </span>
                                </td>
                                <td style="font-size:0.82rem;color:var(--text-muted)"><?php echo e($el->rubrique ?? '—'); ?></td>
                                <td><?php echo e($el->label); ?></td>
                                <td class="<?php echo e($el->category === 'gain' ? 'bonus' : 'deduction'); ?> font-semibold">
                                    <?php echo e($el->category === 'gain' ? '+' : '-'); ?><?php echo e(number_format($el->amount, 2, ',', ' ')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\SIRH-v2\resources\views/variable-elements/index.blade.php ENDPATH**/ ?>