...
<?php $__currentLoopData = $variableGains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ve): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
    <td class="col-libelle"><?php echo e($ve->label); ?></td>
    <td class="col-nbre-taux"></td>
    <td class="col-gain"><?php echo e(number_format($ve->amount, 2, ',', ' ')); ?></td>
    <td class="col-total"></td>
    <td class="col-retenues"></td>
</tr>
...
<?php /**PATH D:\Projects\SIRH-\resources\views/salary/bulletin_de_paie.blade.php ENDPATH**/ ?>