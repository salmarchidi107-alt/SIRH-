...
<div class="profile-hero mb-6">
    ...
    <div class="profile-meta">
        <div class="profile-meta-item">
            <div class="profile-meta-value"><?php echo e($employee->hire_date ? round($employee->hire_date->floatDiffInYears(now()), 1) : 'N/A'); ?></div>
            ...
            <div class="card-body">
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value"><?php echo e($employee->birth_date ? $employee->birth_date->format('d/m/Y') : '—'); ?></div>
                    </div>
                    <div class="detail-item">
            ...
            <div class="card-body">
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value"><?php echo e($employee->hire_date->format('d/m/Y')); ?></div>
                    </div>
                    <div class="detail-item">
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
                    ...
                    <div style="text-align: center; padding: 16px 8px; background: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                        ...
                        <div style="font-size: 0.9rem; font-weight: 600; color: #1e293b; margin-top: 4px;">
                            <?php echo e(optional($employee->contract_end_date)->format('d/m/Y') ?: '—'); ?>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-top: 16px;">
                    ...
                    <div style="padding: 20px; background: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); text-align: center;">
                        <div style="width: 56px; height: 56px; margin: 0 auto 12px; background: <?php echo e($cpBg); ?>; border-radius: 16px; display: flex; align-items: center; justify-content: center;">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($cpStroke); ?>" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div style="font-size: 2rem; font-weight: 700; color: <?php echo e($cpColor); ?>; margin-top: 8px; line-height: 1.1;">
                            <?php echo e(round($cpJours)); ?>
                    ...
                    <div style="padding: 20px; background: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); text-align: center;">
                        ...
                        <div style="font-size: 2rem; font-weight: 700; color: #0891b2; margin-top: 8px; line-height: 1.1;">
                            <?php echo e(round($heuresCounter)); ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif($ab->status == 'pending'): ?>
                                        <span class="badge badge-warning">En attente</span>
                                    <?php elseif($ab->status == 'rejected'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/employees/show.blade.php ENDPATH**/ ?>