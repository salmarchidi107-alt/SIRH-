        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center space-x-4 pt-2">
                <?php if($tenant->logo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $tenant->logo_path)); ?>" alt="Logo" class="w-16 h-16 rounded-lg object-cover shadow-md">
                <?php endif; ?>
                <div>
...
<?php /**PATH C:\Users\HP\SIRH-\resources\views/superadmin/tenants/show.blade.php ENDPATH**/ ?>