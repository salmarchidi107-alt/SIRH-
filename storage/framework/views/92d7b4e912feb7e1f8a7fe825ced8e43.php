                ...
                <table class="sa-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="sa-badge sa-badge--<?php echo e($client->plan->badgeClass()); ?>">
                                    <?php echo e($client->plan->label()); ?>

                                </span>
                            </td>
                            <td>
                                <span class="sa-badge sa-badge--<?php echo e($client->status->badgeClass()); ?>">
                            ...
                            <td>
                                <a href="<?php echo e(route('superadmin.tenants.show', $client)); ?>" class="sa-btn sa-btn--xs sa-btn--outline-primary">
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/superadmin/clients/index.blade.php ENDPATH**/ ?>