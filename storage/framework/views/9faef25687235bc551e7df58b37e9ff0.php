...
<?php $__env->startSection('page-title', 'Modifier le Modèle'); ?>
...
<div class="container-fluid py-4 px-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        <a href="<?php echo e(route('ged.modeles.index')); ?>" style="color:#64748b;font-size:13px;text-decoration:none;">
            <i class="fas fa-layer-group me-1"></i>Modèles
        </a>
        <span style="color:#cbd5e1;">›</span>
        <span style="color:#0d2238;font-size:13px;font-weight:600;"><?php echo e($modele->nom); ?></span>
    </div>

    <form method="POST" action="<?php echo e(route('ged.modeles.update', $modele)); ?>" id="editForm">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body p-4" style="display:flex;flex-direction:column;gap:16px;">
                        <div>
                            ...
                            <input type="text" name="nom" class="ged-input"
                                   value="<?php echo e(old('nom', $modele->nom)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="categorie" class="ged-input"
                                   value="<?php echo e(old('categorie', $modele->categorie)); ?>"
...
<script>
const contenuOriginal = atob(<?php echo json_encode($contenuModele, 15, 512) ?>);
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SIRH-\resources\views/ged/modeles-edit.blade.php ENDPATH**/ ?>