...
var currentPage  = <?php echo e($employees->currentPage()); ?>;
var totalResults = <?php echo e($employees->total()); ?>;
var hasMore      = <?php echo e($employees->hasMorePages() ? 'true' : 'false'); ?>;
<?php else: ?>
var currentPage  = 1;
var totalResults = <?php echo e($employees->count()); ?>;
var hasMore      = false;
<?php endif; ?>

var isLoading    = false;
var searchParams = new URLSearchParams(window.location.search);
var isAdmin      = <?php echo json_encode(in_array(auth()->user()->role ?? '', ['admin', 'rh'])) ?>;
...
function ajaxEmployees(page, append) {
    ...
    .then(function(data) {
        ...
        if (page === 1) {
            history.replaceState({}, '', '<?php echo e(route('employees.index')); ?>?' + searchParams.toString());
        }
    })
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/employees/index.blade.php ENDPATH**/ ?>