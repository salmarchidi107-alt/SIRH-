    ...
    <div class="stat-card" style="background: linear-gradient(135deg, #f59e0b, #fbbf24); padding: 20px; border-radius: 12px; color: white;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div style="font-size: 1.8rem; font-weight: 700;"><?php echo e($pendingCount); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="stat-card" style="background: linear-gradient(135deg, #0ea5e9, #38bdf8); padding: 20px; border-radius: 12px; color: white;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div style="font-size: 1.8rem; font-weight: 700;"><?php echo e($newsCount); ?></div>
            </div>
        </div>
    </div>
</div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding: 0;">
            <?php if($pendingAbsences->count() > 0): ?>
                <div style="display: flex; flex-direction: column;">
                    <?php $__currentLoopData = $pendingAbsences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="display: flex; align-items: center; gap: 12px; padding: 14px 20px; border-bottom: 1px solid #f0f0f0; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                        <div style="width: 44px; height: 44px; border-radius: 50%; background: linear-gradient(135deg, #f59e0b, #fbbf24); color: white; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 0.85rem; flex-shrink: 0;">
                            <?php echo e(strtoupper(substr($absence->employee->first_name ?? 'E', 0, 1))); ?><?php echo e(strtoupper(substr($absence->employee->last_name ?? '', 0, 1))); ?>

                        </div>
                        <div style="flex: 1; min-width: 0;">
                            <div style="font-weight: 600; font-size: 0.9rem; color: var(--text);">
                                <?php echo e($absence->employee->full_name ?? 'Employe'); ?>
                            ...
                            <div style="font-size: 0.75rem; color: #999;">
                                Demandé le <?php echo e($absence->created_at->format('d/m/Y')); ?>

                            </div>
                        </div>
                        <div style="display: flex; gap: 8px; flex-shrink: 0;">
                            <form method="POST" action="<?php echo e(route('absences.approve', $absence)); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <form method="POST" action="<?php echo e(route('absences.reject', $absence)); ?>">
                                <?php echo csrf_field(); ?>
        ...
        <div class="card-body" style="padding: 0;">
            <?php if($recentNews->count() > 0): ?>
                <div style="display: flex; flex-direction: column;">
                    ...
                    <a href="<?php echo e(route('news.show', $news)); ?>" style="display: flex; align-items: center; gap: 12px; padding: 14px 20px; border-bottom: 1px solid #f0f0f0; text-decoration: none; color: inherit; transition: background 0.2s;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background='transparent'">
                        <?php if($news->image): ?>
                        <div style="width: 44px; height: 44px; border-radius: 8px; background: url('<?php echo e(asset($news->image)); ?>'); background-size: cover; background-position: center; flex-shrink: 0;"></div>
                        <?php else: ?>
                        ...
                        <div style="flex: 1; min-width: 0;">
                            ...
                            <div style="font-size: 0.8rem; color: #666; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                <?php echo e(Str::limit($news->content, 60)); ?>

                            </div>
                            <div style="font-size: 0.75rem; color: #999;">
                                Publie le <?php echo e($news->created_at->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SIRH-\resources\views/notifications/index.blade.php ENDPATH**/ ?>