        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?php if($absence->status == 'pending'): ?>
                    ...
                    <?php if(auth()->user()->can('approve_absences')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SIRH-\resources\views/absences/show.blade.php ENDPATH**/ ?>