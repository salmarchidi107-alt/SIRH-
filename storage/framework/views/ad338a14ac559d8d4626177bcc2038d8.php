...
/* ── Formulaire d'affectation (grille 2 colonnes) ── */
.aff-grid {
    display: grid;
    grid-template-columns: repeat(3, 1fr);
    gap: 16px;
}
.aff-grid .full { grid-column: 1 / -1; }
...
<div style="background:#fff;border-bottom:1px solid #e2e8f0;margin:-16px -16px 24px;padding:0">
    ...
    <div class="eq-nav" style="margin:0;border-bottom:none">
        ...
        <a href="<?php echo e(route('equipements.index', ['tab' => 'decharge'])); ?>"
           class="eq-tab <?php echo e(in_array($tab, ['decharge', 'retour']) ? 'active' : ''); ?>">Décharges &amp; Retours</a>
    </div>
</div>
...
<div class="eq-page <?php echo e($tab === 'dash' ? 'active' : ''); ?>">
    ...
    <div class="eq-alert error" style="margin-bottom:16px">
        <div>
            <strong><?php echo e($alertes_depart->count()); ?> alerte(s) départ</strong>
            — équipements toujours affectés non restitués.
            <a href="<?php echo e(route('equipements.index', ['tab' => 'decharge'])); ?>" style="color:#991b1b;font-weight:600;text-decoration:underline;margin-left:6px">Voir</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="eq-card">
        <div class="eq-card-title">
            ...
            <a href="<?php echo e(route('equipements.export', ['type' => 'affectations'])); ?>"
        ...
        <table class="eq-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $dernieres_affectations->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
    ...
    <div class="eq-card" style="padding:14px 18px;margin-bottom:16px">
        <form method="GET" action="<?php echo e(route('equipements.index')); ?>"
            ...
            <div style="margin-left:auto;display:flex;gap:8px">
                <a href="<?php echo e(route('equipements.export', array_merge(['type' => 'catalogue'], request()->only(['search', 'categorie', 'statut'])))); ?>"
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <div style="display:inline-flex;gap:6px;align-items:center">
                                ...
                                <?php if($eq->statut !== 'Affecté'): ?>
                                <form method="POST" action="<?php echo e(route('equipements.destroy', $eq->id)); ?>"
                                      onsubmit="return confirm('Supprimer définitivement « <?php echo e(addslashes($eq->designation)); ?> » (<?php echo e($eq->reference); ?>) ? Cette action est irréversible.');"
            ...
            <div class="aff-grid">
                ...
                <div class="fgroup full">
                    ...
                    <select name="equipement_id" id="sel-equipement" onchange="updateEquipementInfo(this)" required>
                        ...
                        <option value="<?php echo e($eq->id); ?>"
                            data-desig="<?php echo e($eq->designation); ?>"
                            data-ref="<?php echo e($eq->reference); ?>"
                            data-etat="<?php echo e($eq->etat); ?>"
                            <?php echo e((request('equipement_id') == $eq->id) ? 'selected' : ''); ?>>
                            <?php echo e($eq->reference); ?> — <?php echo e($eq->designation); ?> (<?php echo e($eq->etat); ?>)
                        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($equipements_disponibles->isEmpty()): ?>
...
<div class="eq-page <?php echo e($tab === 'salarie' ? 'active' : ''); ?>">
    ...
    <div class="eq-card">
        <div class="eq-card-title">
            ...
            <a href="<?php echo e(route('equipements.export', ['type' => 'salaries'])); ?>"
               style="margin-left:auto;display:inline-flex;align-items:center;gap:5px;font-size:12px;color:#14b8a6;text-decoration:none;font-weight:500;border:1px solid #ccfbf1;background:#f0fdfa;border-radius:7px;padding:5px 10px">
                <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 3v12m0 0-4-4m4 4 4-4"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/></svg>
                Exporter
            </a>
                ...
                <tr>
                    ...
                    <td style="text-align:center">
                        <div style="display:inline-flex;gap:6px">
                            ...
                            <a href="<?php echo e(route('equipements.fiche_salarie.pdf', $empId)); ?>"
...
<div class="eq-page <?php echo e(in_array($tab, ['decharge', 'retour']) ? 'active' : ''); ?>">
    ...
    <div class="eq-card">
        <div class="eq-card-title">
            ...
            <span style="font-size:11px;color:#94a3b8;font-weight:400"><?php echo e($toutes_affectations_actives->count()); ?> au total</span>
            <a href="<?php echo e(route('equipements.export', ['type' => 'decharges'])); ?>"
               style="margin-left:auto;display:inline-flex;align-items:center;gap:5px;font-size:12px;color:#14b8a6;text-decoration:none;font-weight:500;border:1px solid #ccfbf1;background:#f0fdfa;border-radius:7px;padding:5px 10px">
                <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 3v12m0 0-4-4m4 4 4-4"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/></svg>
                Exporter
            </a>
        ...
        <div style="overflow-x:auto">
            <table class="eq-table" style="min-width:900px">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $toutes_affectations_actives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $enDepart = ($aff->employee->status ?? 'active') === 'inactive'; ?>
                    <tr>
                        <td style="font-weight:500"><?php echo e($aff->employee->first_name ?? ''); ?> <?php echo e($aff->employee->last_name ?? '—'); ?></td>
                        <td style="color:#64748b">
                            <?php echo e($aff->equipement->designation ?? '—'); ?>

                            <span class="mono" style="color:#94a3b8">(<?php echo e($aff->equipement->reference ?? ''); ?>)</span>
                        </td>
                        <td style="color:#64748b;font-size:12px"><?php echo e(optional($aff->date_affectation)->format('d/m/Y')); ?></td>
                        <td style="color:#64748b;font-size:12px">
                            <?php echo e($aff->date_retour_prevue ? optional($aff->date_retour_prevue)->format('d/m/Y') : 'Non défini'); ?>
                        ...
                        <td style="text-align:center">
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('equipements.signer_decharge', $aff->id)); ?>" style="display:inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                        ...
                        <td style="text-align:center">
                            <span class="eq-badge <?php echo e($enDepart ? 'b-red' : 'b-blue'); ?>"><?php echo e($enDepart ? 'Départ' : 'En cours'); ?></span>
                        </td>
                        <td style="text-align:center">
                            <div style="display:inline-flex;gap:6px">
                                <a href="<?php echo e(route('equipements.index', ['tab' => 'decharge', 'affectation_id' => $aff->id])); ?>#restitution"
                                ...
                                <?php if($enDepart): ?>
                                <form method="POST" action="<?php echo e(route('equipements.declarer_perte', $aff->id)); ?>" style="display:inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
    ...
    <div id="restitution" class="eq-card">
        ...
        <?php if($toutes_affectations_actives->isNotEmpty()): ?>
        <?php
        ...
        ?>
        <form method="POST" action="<?php echo e(route('equipements.restituer', $defaultAffId)); ?>">
            <?php echo csrf_field(); ?>
            <div style="display:flex;flex-direction:column;gap:10px">
                <div class="fgroup">
                    <label>Équipement restitué</label>
                    <select name="affectation_id_display" disabled style="background:#f8fafc">
                        <?php $__currentLoopData = $toutes_affectations_actives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e((int) request('affectation_id') === $aff->id ? 'selected' : ''); ?>>
                            <?php echo e($aff->equipement->reference ?? ''); ?> — <?php echo e($aff->equipement->designation ?? ''); ?>

                            (<?php echo e($aff->employee->first_name ?? ''); ?> <?php echo e($aff->employee->last_name ?? ''); ?>)
                        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
