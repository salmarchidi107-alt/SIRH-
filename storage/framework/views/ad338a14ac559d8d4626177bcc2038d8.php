<?php $__env->startSection('title', 'Gestion des équipements'); ?>
<?php $__env->startSection('page-title', 'Équipements'); ?>
...
<div style="background:#fff;border-bottom:1px solid #e2e8f0;margin:-16px -16px 24px;padding:0">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;padding:16px 20px 0">
        ...
        <div style="display:flex;gap:8px;align-items:center">
            <?php if($alertes_depart->isNotEmpty()): ?>
            <span style="background:#fef2f2;color:#991b1b;border:1px solid #fecaca;border-radius:99px;padding:4px 12px;font-size:12px;font-weight:600">
                <?php echo e($alertes_depart->count()); ?> alerte(s) départ
            </span>
            <?php endif; ?>
            <a href="<?php echo e(route('equipements.index', ['tab' => 'affecter'])); ?>"
    ...
    <div class="eq-nav" style="margin:0;border-bottom:none">
        <a href="<?php echo e(route('equipements.index', ['tab' => 'dash'])); ?>"
           class="eq-tab <?php echo e($tab === 'dash' ? 'active' : ''); ?>">Tableau de bord</a>
        <a href="<?php echo e(route('equipements.index', ['tab' => 'catalogue'])); ?>"
           class="eq-tab <?php echo e($tab === 'catalogue' ? 'active' : ''); ?>">Catalogue</a>
        <a href="<?php echo e(route('equipements.index', ['tab' => 'affecter'])); ?>"
           class="eq-tab <?php echo e($tab === 'affecter' ? 'active' : ''); ?>">Affectation</a>
        <a href="<?php echo e(route('equipements.index', ['tab' => 'salarie'])); ?>"
           class="eq-tab <?php echo e($tab === 'salarie' ? 'active' : ''); ?>">Fiche salarié</a>
        <a href="<?php echo e(route('equipements.index', ['tab' => 'decharge'])); ?>"
           class="eq-tab <?php echo e($tab === 'decharge' ? 'active' : ''); ?>">Décharges</a>
        <a href="<?php echo e(route('equipements.index', ['tab' => 'retour'])); ?>"
           class="eq-tab <?php echo e($tab === 'retour' ? 'active' : ''); ?>">Retours / Départ</a>
    </div>
</div>
...
<div class="eq-page <?php echo e($tab === 'dash' ? 'active' : ''); ?>">

    
    <form method="GET" action="<?php echo e(route('equipements.index')); ?>" class="dash-filter">
        <input type="hidden" name="tab" value="dash">
        <label>Catégorie :</label>
        <select name="dash_cat">
            <option value="">Toutes les catégories</option>
            <?php $__currentLoopData = $liste_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($cat); ?>" <?php echo e(request('dash_cat') === $cat ? 'selected' : ''); ?>><?php echo e($cat); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <label>Du :</label>
        <input type="date" name="dash_from" value="<?php echo e(request('dash_from')); ?>">
        <label>Au :</label>
        <input type="date" name="dash_to" value="<?php echo e(request('dash_to')); ?>">
        ...
        <?php if(request('dash_cat') || request('dash_from') || request('dash_to')): ?>
            <a href="<?php echo e(route('equipements.index', ['tab' => 'dash'])); ?>" class="dash-filter-reset">
    ...
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:14px;margin-bottom:20px">
        ...
        <a href="<?php echo e(route('equipements.index', array_merge($dashParams, ['tab' => 'catalogue']))); ?>"
           class="eq-stat-card teal" title="Voir tout le catalogue">
            <div class="stat-val"><?php echo e($metrics['total']); ?></div>
            <div class="stat-label">Total</div>
        </a>

        <a href="<?php echo e(route('equipements.index', array_merge($dashParams, ['tab' => 'catalogue', 'statut' => 'Affecté']))); ?>"
           class="eq-stat-card blue" title="Voir les équipements affectés">
            <div class="stat-val"><?php echo e($metrics['affectes']); ?></div>
            <div class="stat-label">Affectés</div>
        </a>

        <a href="<?php echo e(route('equipements.index', array_merge($dashParams, ['tab' => 'catalogue', 'statut' => 'Disponible']))); ?>"
           class="eq-stat-card green" title="Voir les équipements disponibles">
            <div class="stat-val"><?php echo e($metrics['disponibles']); ?></div>
            <div class="stat-label">Disponibles</div>
        </a>

        <a href="<?php echo e(route('equipements.index', array_merge($dashParams, ['tab' => 'catalogue', 'statut' => 'Maintenance']))); ?>"
           class="eq-stat-card amber" title="Voir les équipements en maintenance">
            <div class="stat-val"><?php echo e($metrics['maintenance']); ?></div>
            <div class="stat-label">Maintenance</div>
        </a>

        <a href="<?php echo e(route('equipements.index', array_merge($dashParams, ['tab' => 'catalogue', 'statut' => 'Perdu']))); ?>"
           class="eq-stat-card red" title="Voir les équipements perdus">
            <div class="stat-val"><?php echo e($metrics['perdus']); ?></div>
            <div class="stat-label">Perdus</div>
        </a>

        
        <div class="eq-stat-card teal" style="border-top-color:#8b5cf6">
            <div class="stat-val" style="font-size:17px"><?php echo e(number_format($metrics['valeur_parc'], 0, ',', ' ')); ?></div>
    ...
    <div class="eq-grid2">
        <div>
            ...
            <div class="eq-card">
                ...
                <?php $totalEq = max($metrics['total'], 1); ?>
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('equipements.index', ['tab' => 'catalogue', 'categorie' => $cat->categorie])); ?>"
                   style="text-decoration:none;display:block;margin-bottom:12px">
                    <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:4px">
                        <span style="font-weight:500;color:#374151"><?php echo e($cat->categorie); ?></span>
                        <span style="color:#64748b">
                            <?php echo e($cat->total); ?> / <?php echo e($metrics['total']); ?>

                            <span style="color:#14b8a6;font-size:10px;margin-left:4px">→ voir</span>
                        </span>
                    </div>
                    <div class="eq-bar">
                        <div class="eq-bar-fill" style="width:<?php echo e(round($cat->total / $totalEq * 100)); ?>%"></div>
                    </div>
                </a>
        ...
        <div>
            ...
            <div class="eq-card" style="margin-bottom:16px">
                ...
                <div class="eq-alert error">
                    <div><strong><?php echo e($alertes_depart->count()); ?> contrat(s) terminé(s)</strong> — équipements toujours affectés non restitués</div>
                </div>
                <a href="<?php echo e(route('equipements.index', ['tab' => 'retour'])); ?>"
            ...
            <div class="eq-card">
                ...
                <table class="eq-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $dernieres_affectations->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="clickable-row" onclick="showAffDetail(<?php echo e($detailData); ?>)" title="Voir le détail">
                            <td style="font-weight:500"><?php echo e($aff->employee->first_name ?? ''); ?> <?php echo e($aff->employee->last_name ?? '—'); ?></td>
                            <td style="color:#64748b"><?php echo e($aff->equipement->designation ?? '—'); ?></td>
...
<div class="eq-page <?php echo e($tab === 'catalogue' ? 'active' : ''); ?>">

    <div class="eq-card" style="padding:14px 18px;margin-bottom:16px">
        <form method="GET" action="<?php echo e(route('equipements.index')); ?>"
            ...
            <select name="statut"
                ...
                <option value="Disponible"  <?php echo e(request('statut') === 'Disponible'  ? 'selected' : ''); ?>>Disponible</option>
                <option value="Affecté"     <?php echo e(request('statut') === 'Affecté'     ? 'selected' : ''); ?>>Affecté</option>
            ...
            <?php if(request('search') || request('categorie') || request('statut')): ?>
            <a href="<?php echo e(route('equipements.index', ['tab' => 'catalogue'])); ?>"
    ...
    <div id="add-eq-form" style="display:none;margin-bottom:16px">
        <div class="eq-card">
            ...
            <form method="POST" action="<?php echo e(route('equipements.store')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="eq-card" style="padding:0;overflow:hidden">
        <div style="overflow-x:auto">
            <table class="eq-table" style="min-width:850px">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $equipements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="mono" style="font-weight:600;color:#0f172a"><?php echo e($eq->reference); ?></td>
                        <td style="font-weight:500"><?php echo e($eq->designation); ?></td>
                        <td><span class="<?php echo e($eq->categorie_color); ?>"><?php echo e($eq->categorie); ?></span></td>
                        <td style="color:#64748b"><?php echo e($eq->marque ?? '—'); ?></td>
                        <td class="mono" style="color:#64748b"><?php echo e($eq->numero_serie ?? '—'); ?></td>
                        <td><span class="<?php echo e($eq->etat_color); ?>"><?php echo e($eq->etat); ?></span></td>
                        <td><span class="<?php echo e($eq->statut_color); ?>"><?php echo e($eq->statut); ?></span></td>
                        <td style="text-align:right;font-weight:600"><?php echo e(number_format($eq->valeur_acquisition, 0, ',', ' ')); ?></td>
                        <td style="text-align:center">
                            <?php if($eq->statut === 'Disponible'): ?>
                            <a href="<?php echo e(route('equipements.index', ['tab' => 'affecter', 'equipement_id' => $eq->id])); ?>"
                            ...
                            <?php elseif($eq->affectationActive && $eq->affectationActive->employee_id): ?>
                            <a href="<?php echo e(route('equipements.fiche_salarie', $eq->affectationActive->employee_id)); ?>"
    ...
    <div style="margin-top:12px"><?php echo e($equipements->appends(request()->query())->links()); ?></div>
</div>



<div class="eq-page <?php echo e($tab === 'affecter' ? 'active' : ''); ?>">
    <div class="eq-grid2">
        <div>
            <div class="eq-card">
                <div class="eq-card-title">Nouvelle affectation</div>
                <form method="POST" action="<?php echo e(route('equipements.affecter')); ?>">
                    <?php echo csrf_field(); ?>
                    <div style="display:flex;flex-direction:column;gap:12px">
                        <div class="fgroup">
                            ...
                            <select name="employee_id" id="sel-salarie" onchange="updateSalarieInfo(this)" required>
                                ...
                                <?php $__currentLoopData = $employees_actifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($emp->id); ?>"
                                    data-nom="<?php echo e($emp->first_name); ?> <?php echo e($emp->last_name); ?>"
                                    data-fonction="<?php echo e($emp->position ?? $emp->poste ?? ''); ?>"
                                    data-service="<?php echo e($emp->department ?? $emp->departement ?? ''); ?>"
                                    data-mat="<?php echo e($emp->employee_number ?? $emp->matricule ?? ''); ?>"
                                    <?php echo e((request('employee_id') == $emp->id) ? 'selected' : ''); ?>>
                                    <?php echo e($emp->first_name); ?> <?php echo e($emp->last_name); ?>

                                    <?php if($emp->employee_number ?? $emp->matricule ?? ''): ?>
                                        — <?php echo e($emp->employee_number ?? $emp->matricule); ?>
                        ...
                        <div class="fgroup">
                            ...
                            <select name="equipement_id" required>
                                ...
                                <?php $__currentLoopData = $equipements_disponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($eq->id); ?>" <?php echo e((request('equipement_id') == $eq->id) ? 'selected' : ''); ?>>
                                    <?php echo e($eq->reference); ?> — <?php echo e($eq->designation); ?> (<?php echo e($eq->etat); ?>)
                                </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                            <div class="fgroup">
                                ...
                                <input type="date" name="date_affectation" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                            <div class="fgroup">
...
<div class="eq-page <?php echo e($tab === 'salarie' ? 'active' : ''); ?>">
        ...
        <div style="display:flex;gap:10px;align-items:flex-end">
            <div class="fgroup" style="flex:1">
                ...
                <select id="sel-salarie-view" style="height:36px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;padding:0 12px;background:#fff">
                    ...
                    <?php $__currentLoopData = $employees_actifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($emp->id); ?>"><?php echo e($emp->first_name); ?> <?php echo e($emp->last_name); ?> — <?php echo e($emp->employee_number ?? $emp->matricule ?? ''); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <button type="button"
                    style="height:36px;padding:0 18px;background:#14b8a6;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer;display:inline-flex;align-items:center;gap:6px"
                    onclick="var v=document.getElementById('sel-salarie-view').value; if(v) window.location='<?php echo e(url('equipements/salarie')); ?>/'+v;">
                Consulter la fiche
            </button>
        </div>
    </div>
            ...
            <tbody>
                <?php
                    $salaries_eq = \App\Models\AffectationEquipement::where('tenant_id', auth()->user()->tenant_id)
                        ...
                        ->groupBy('employee_id');
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $salaries_eq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empId => $affs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr>
                    <td>
                        <div style="display:flex;align-items:center;gap:10px">
                            <?php $ini = mb_strtoupper(mb_substr($emp->first_name ?? 'X', 0, 1) . mb_substr($emp->last_name ?? 'X', 0, 1)); ?>
                            <div class="eq-avatar" style="width:32px;height:32px;font-size:12px"><?php echo e($ini); ?></div>
                            <span style="font-weight:500"><?php echo e($emp->first_name); ?> <?php echo e($emp->last_name); ?></span>
                        </div>
                    </td>
                    <td class="mono"><?php echo e($emp->employee_number ?? $emp->matricule ?? '—'); ?></td>
                    <td><span class="eq-badge b-teal"><?php echo e($affs->count()); ?></span></td>
                    <td style="font-weight:600"><?php echo e(number_format($valeur, 0, ',', ' ')); ?> MAD</td>
                    <td style="text-align:center">
                        <a href="<?php echo e(route('equipements.fiche_salarie', $empId)); ?>"
...
<div class="eq-page <?php echo e($tab === 'decharge' ? 'active' : ''); ?>">
    <div class="eq-grid2">
        <div>
            <?php if($decharges_en_attente->isNotEmpty()): ?>
            <?php $first = $decharges_en_attente->first(); ?>
            <div class="eq-card">
                <div class="eq-card-title">Aperçu — <?php echo e($first->numero_decharge); ?></div>
                <div class="decharge-preview">
                    <div style="text-align:center;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid #e2e8f0">
                        ...
                        <div style="color:#64748b;font-size:12px;margin-top:4px">N° <?php echo e($first->numero_decharge); ?> — <?php echo e(now()->format('d/m/Y')); ?></div>
                    </div>
                    <div style="margin-bottom:12px">
                        ...
                        <table style="font-size:12px;width:100%">
                            <tr><td style="color:#64748b;padding:3px 0;width:120px">Nom & prénom</td><td style="font-weight:600;color:#0f172a"><?php echo e($first->employee->first_name ?? ''); ?> <?php echo e($first->employee->last_name ?? '—'); ?></td></tr>
                            <tr><td style="color:#64748b;padding:3px 0">Matricule</td><td><?php echo e($first->employee->employee_number ?? $first->employee->matricule ?? '—'); ?></td></tr>
                            <tr><td style="color:#64748b;padding:3px 0">Fonction</td><td><?php echo e($first->employee->position ?? $first->employee->poste ?? '—'); ?></td></tr>
                            <tr><td style="color:#64748b;padding:3px 0">Service</td><td><?php echo e($first->employee->department ?? $first->employee->departement ?? '—'); ?></td></tr>
                        </table>
                    </div>
                    <div style="margin-bottom:12px;padding-top:12px;border-top:1px solid #e2e8f0">
                        ...
                        <table style="font-size:12px;width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:4px 0;font-weight:500"><?php echo e($first->equipement->designation ?? '—'); ?></td>
                                    <td class="mono"><?php echo e($first->equipement->reference ?? '—'); ?></td>
                                    <td><?php echo e($first->etat_remise); ?></td>
                                    <td style="text-align:right;font-weight:600"><?php echo e(number_format($first->equipement->valeur_acquisition ?? 0, 0, ',', ' ')); ?> MAD</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div style="padding-top:12px;border-top:1px solid #e2e8f0;font-size:11px;color:#64748b;line-height:1.7;margin-bottom:16px">
                        Je soussigné(e) <strong style="color:#0f172a"><?php echo e($first->employee->first_name ?? ''); ?> <?php echo e($first->employee->last_name ?? ''); ?></strong>,
        ...
        <div>
            ...
            <div class="eq-card" style="margin-bottom:16px">
                ...
                <div style="display:flex;flex-direction:column;gap:8px">
                    ...
                    <form method="POST" action="<?php echo e(route('equipements.signer_decharge', $decharges_en_attente->first()->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
            ...
            <div class="eq-card">
                ...
                <div style="display:flex;flex-direction:column;gap:8px">
                    <?php $__empty_1 = true; $__currentLoopData = $decharges_en_attente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:#f8fafc;border-radius:8px;border:1px solid #f1f5f9">
                        <div>
                            <div style="font-size:13px;font-weight:600;color:#0f172a"><?php echo e($dch->numero_decharge); ?></div>
                            <div style="font-size:11px;color:#64748b;margin-top:2px">
                                <?php echo e($dch->employee->first_name ?? ''); ?> <?php echo e($dch->employee->last_name ?? ''); ?>

                                — <?php echo e($dch->equipement->reference ?? ''); ?>
...
<div class="eq-page <?php echo e($tab === 'retour' ? 'active' : ''); ?>">

    <?php if($alertes_depart->isNotEmpty()): ?>
    <div class="eq-alert error" style="margin-bottom:16px">
        <div>
            <strong>Alerte départ :</strong>
            <?php echo e($alertes_depart->count()); ?> salarié(s) avec contrat terminé ont des équipements non restitués.
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="eq-grid2">
        <div>
            <?php if($employes_depart->isNotEmpty()): ?>
            <?php $emp_dep = $employes_depart->first(); ?>
            <div class="eq-card">
                <div class="eq-card-title">
                    Checklist — <?php echo e($emp_dep->first_name); ?> <?php echo e($emp_dep->last_name); ?>
                ...
                <div style="border:1px solid #fee2e2;border-radius:8px;overflow:hidden;margin-bottom:12px">
                    <div style="padding:10px 14px;background:#fef2f2;font-size:12px;font-weight:600;display:flex;justify-content:space-between;color:#991b1b">
                        ...
                        <span><?php echo e($emp_dep->affectationsEquipements->count()); ?> en attente</span>
                    </div>
                    <?php $__currentLoopData = $emp_dep->affectationsEquipements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="eq-check-item">
                        <input type="checkbox" id="ck-<?php echo e($aff->id); ?>" onchange="checkAll()">
                        <div style="flex:1">
                            <div style="font-weight:600;font-size:13px;color:#0f172a">
                                <?php echo e($aff->equipement->designation ?? '—'); ?>

                                <span class="mono" style="color:#64748b">(<?php echo e($aff->equipement->reference ?? ''); ?>)</span>
                            </div>
                            <div style="font-size:11px;color:#64748b;margin-top:2px">
                                Affecté depuis le <?php echo e(optional($aff->date_affectation)->format('d/m/Y')); ?>

                                — <?php echo e(number_format($aff->equipement->valeur_acquisition ?? 0, 0, ',', ' ')); ?> MAD
                            </div>
                        </div>
                ...
                <div class="btn-row">
                    <form method="POST" action="<?php echo e(route('equipements.declarer_perte', $emp_dep->affectationsEquipements->first()->id ?? 0)); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                    ...
                    <form method="POST" action="<?php echo e(route('equipements.valider_sortie', $emp_dep->id)); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div>
            <div class="eq-card" style="margin-bottom:16px">
                ...
                <?php if($employes_depart->isNotEmpty()): ?>
                <form method="POST" action="<?php echo e(route('equipements.restituer', $employes_depart->first()->affectationsEquipements->first()->id ?? 0)); ?>">
                    <?php echo csrf_field(); ?>
                    <div style="display:flex;flex-direction:column;gap:10px">
                        <div class="fgroup">
                            <label>Équipement restitué</label>
                            <select name="affectation_id">
                                <?php $__currentLoopData = $employes_depart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e_dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $e_dep->affectationsEquipements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($aff->id); ?>">
                                    <?php echo e($aff->equipement->reference ?? ''); ?> — <?php echo e($aff->equipement->designation ?? ''); ?>

                                    (<?php echo e($e_dep->first_name); ?> <?php echo e($e_dep->last_name); ?>)
                                </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                            <div class="fgroup">
                                ...
                                <input type="date" name="date_retour_effectif" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                            <div class="fgroup">
            ...
            <div class="eq-card">
                ...
                <div style="display:flex;flex-direction:column;gap:8px">
                    <?php $__empty_1 = true; $__currentLoopData = $employes_depart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e_dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $ini2 = mb_strtoupper(mb_substr($e_dep->first_name ?? 'X', 0, 1) . mb_substr($e_dep->last_name ?? 'X', 0, 1)); ?>
                    <div style="display:flex;align-items:center;gap:12px;padding:10px 14px;background:#fef2f2;border-radius:8px;border:1px solid #fecaca">
                        <div class="eq-avatar" style="width:34px;height:34px;font-size:12px;background:linear-gradient(135deg,#ef4444,#f97316)"><?php echo e($ini2); ?></div>
                        <div style="flex:1">
                            <div style="font-size:13px;font-weight:600;color:#0f172a"><?php echo e($e_dep->first_name); ?> <?php echo e($e_dep->last_name); ?></div>
                            <div style="font-size:11px;color:#64748b;margin-top:1px"><?php echo e($e_dep->affectationsEquipements->count()); ?> équipement(s) en attente</div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SIRH-\resources\views/equipements/index.blade.php ENDPATH**/ ?>