...
<?php
        ...
        <a href="<?php echo e(route('pointage.index', ['date' => $nextDate->toDateString()])); ?>" class="pt-weeknav-btn">&#8250;</a>
        <a href="<?php echo e(route('pointage.index', ['date' => today()->toDateString()])); ?>"
    ...
    <div class="pt-body">
        ...
        <div class="pt-days">
            ...
            <a href="<?php echo e(route('pointage.index', ['date' => $day['date']->toDateString()])); ?>"
    ...
    <span class="pt-badge pt-badge-absent"
        ...
        Absence
                    ...
                    <td class="pt-shift">
                        <?php if($p && $p->heure_entree && $p->heure_sortie): ?>
                        <?php echo e(\Carbon\Carbon::parse($p->heure_entree)->format('H:i')); ?>

                        – <?php echo e(\Carbon\Carbon::parse($p->heure_sortie)->format('H:i')); ?>
                    ...
                    <td style="text-align:center;font-size:12px;color:var(--p-text-muted);">
                        <?php echo e($p ? $p->pause_minutes : 0); ?>
                    ...
                    <td>
                        ...
                        <span class="pt-total <?php echo e($p->total_heures > 10 ? 'long' : ''); ?>">
                            <?php echo e(number_format($p->total_heures, 2)); ?>h
                        </span>
                        <?php else: ?>
                        <span style="color:var(--p-border)">—</span>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/pointage/index.blade.php ENDPATH**/ ?>