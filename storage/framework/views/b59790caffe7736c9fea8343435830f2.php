                        ...
                        <div class="nf-grid-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="amount_excluding_tax" class="form-control <?php echo e($errors->has('amount_excluding_tax') ? 'is-invalid' : ''); ?>"
                                       id="field_amount_ht" step="0.01" value="<?php echo e(old('amount_excluding_tax', $expense->amount_excluding_tax)); ?>" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="vat_amount" class="form-control <?php echo e($errors->has('vat_amount') ? 'is-invalid' : ''); ?>"
                                       id="field_vat" step="0.01" value="<?php echo e(old('vat_amount', $expense->vat_amount)); ?>" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="amount" class="form-control <?php echo e($errors->has('amount') ? 'is-invalid' : ''); ?>"
                                       id="field_amount" step="0.01" value="<?php echo e(old('amount', $expense->amount)); ?>" placeholder="0.00" required>
