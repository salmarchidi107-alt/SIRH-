...
<div class="page-header">
    <div class="page-header-left">
        <h1>Employés</h1>
        <p><?php echo e($employees->total()); ?> collaborateurs enregistrés</p>
    </div>
...
<div class="filters-bar">
    ...
    <div style="display:flex;gap:8px;flex-direction:row-reverse">
        ...
        <a href="<?php echo e(route('employees.index', ['filter' => 'all'])); ?>"
           class="btn <?php echo e($filter == 'all' ? 'btn-primary' : 'btn-outline'); ?>">
            Tous
        </a>
        <a href="<?php echo e(route('employees.index', ['filter' => 'active'])); ?>"
           class="btn <?php echo e($filter == 'active' ? 'btn-primary' : 'btn-outline'); ?>">
            Actifs
        </a>
    </div>
    <form method="GET" action="<?php echo e(route('employees.index')); ?>" class="filters-bar" style="margin:0;flex-wrap:wrap;gap:12px">
        ...
        <?php if(request()->hasAny(['search','department'])): ?>
            <a href="<?php echo e(route('employees.index', ['filter' => $filter])); ?>" class="btn btn-ghost btn-sm">✕ Réinitialiser</a>
        <?php endif; ?>
    </form>
</div>
...
<tbody id="employees-tbody">
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-neutral"><?php echo e($employee->department->name ?? 'N/A'); ?></span>
                    </td>
...
<?php echo e($employee->status_label ?? $employee->status); ?>
                    ...
                    <td class="text-sm text-muted"><?php echo e($employee->hire_date ? \Carbon\Carbon::parse($employee->hire_date)->format('d/m/Y') : ''); ?></td>
<td>
    ...
    <div id="employees-pagination" style="padding:0 16px;display:flex;gap:12px;align-items:center;justify-content:center;">
        ...
        <button id="load-more-btn" class="btn btn-outline" style="display:<?php echo e($employees->hasMorePages() ? 'block' : 'none'); ?>;">
            Charger plus (Page <?php echo e($employees->currentPage() + 1 ?? 2); ?>)
        </button>
...
async function ajaxEmployees(page = 1, append = false) {
    ...
    try {
        ...
        const newUrl = `<?php echo e(route('employees.index')); ?>?${searchParams.toString()}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/employees/index.blade.php ENDPATH**/ ?>