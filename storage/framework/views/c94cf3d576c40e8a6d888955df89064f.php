    ...
    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
        <form method="GET" action="<?php echo e(route('salary.index')); ?>" style="display:flex;gap:8px">
            ...
            <?php if($search || $department): ?>
                <a href="<?php echo e(route('salary.index', ['year' => $year])); ?>" class="btn btn-ghost">✕ Réinitialiser</a>
            <?php endif; ?>
...
<div class="card">
    <div class="card-header">
        ...
        <div style="display:flex;gap:8px">
            <a href="<?php echo e(route('salary.index', array_merge(request()->only(['month','year']), ['status'=>null]))); ?>"
            ...
            <a href="<?php echo e(route('salary.index', array_merge(request()->only(['month','year']), ['status'=>'draft']))); ?>"
            ...
            <a href="<?php echo e(route('salary.index', array_merge(request()->only(['month','year']), ['status'=>'validated']))); ?>"
            ...
            <a href="<?php echo e(route('salary.index', array_merge(request()->only(['month','year']), ['status'=>'paid']))); ?>"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="font-semibold">
                                <?php echo e($sal ? number_format($sal->gross_salary,0,',',' ').' '.$cur : '—'); ?>
                            ...
                            <td class="deduction" style="font-size:0.85rem">
                                <?php echo e($sal ? number_format($sal->ir_deduction,0,',',' ').' '.$cur : '—'); ?>
                            ...
                            <td class="font-semibold" style="color:var(--success)">
                                <?php if($sal): ?>
                                    ...
                                    <?php if($cur !== 'MAD'): ?>
                                        <div style="font-size:0.7rem;color:var(--text-muted)">(enregistré en <?php echo e($cur); ?>)</div>
                                    <?php endif; ?>
                                <?php else: ?> —
                                <?php endif; ?>
                            </td>
