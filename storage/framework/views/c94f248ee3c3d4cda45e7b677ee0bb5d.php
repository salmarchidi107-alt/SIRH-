        ...
        <div class="sa-card-body" style="display:flex;flex-direction:column;gap:0;">
            ...
            <div class="sa-field">
                ...
                <input type="text" name="company_name" class="sa-input"
                       value="<?php echo e(old('company_name', $tenant->name)); ?>" required maxlength="100">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sa-field">
                ...
                <div id="sector-other-wrap"
                     style="margin-top:8px;display:<?php echo e(old('sector', $tenant->sector) === 'Autre' ? 'block' : 'none'); ?>;">
                    <input type="text" name="sector_other" class="sa-input"
                           value="<?php echo e(old('sector_other', $tenant->sector_other ?? '')); ?>"
            ...
            <div class="sa-field">
                ...
                <select name="region" id="region-select" class="sa-input" required
                    ...
                    <option <?php echo e($selectRegion == $r ? 'selected' : ''); ?>><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <div id="region-other-wrap"
                     style="margin-top:8px;display:<?php echo e(($isCustomRegion || $selectRegion === 'Autre') ? 'block' : 'none'); ?>;">
                    <input type="text" name="region_other" id="region-other-input" class="sa-input"
                           value="<?php echo e($regionOtherVal); ?>"
                           placeholder="Précisez la région..."
                           <?php echo e(($isCustomRegion || $selectRegion === 'Autre') ? 'required' : ''); ?>>
                </div>
...
<div class="sa-field">
    ...
    <select name="timezone" class="sa-input" required>
        ...
        <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($tz); ?>" <?php echo e($selectedTz === $tz ? 'selected' : ''); ?>>
                <?php echo e($tz); ?> (UTC<?php echo e((new \DateTime('now', new \DateTimeZone($tz)))->format('P')); ?>)
            </option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sa-field">
                ...
                <textarea name="address" class="sa-input" rows="2" required maxlength="255"
                          ...
                          placeholder="Ex: 23 Rue Mohammed V, Casablanca"><?php echo e(old('address', $tenant->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="ice" class="sa-input"
                           value="<?php echo e(old('ice', $tenant->ice)); ?>"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;" class="sa-field">
                <div>
                    ...
                    <input type="email" name="email_societe" class="sa-input"
                           value="<?php echo e(old('email_societe', $tenant->email_societe)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sa-field">
                ...
                <div style="margin-bottom:10px;display:flex;align-items:center;gap:10px;">
                    <img src="<?php echo e(asset('storage/' . $tenant->logo_path)); ?>"
                         alt="Logo actuel"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;" class="sa-field">
                <div>
                    ...
                    <input type="text" name="first_name" class="sa-input"
                           value="<?php echo e(old('first_name', $adminFirstName)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="last_name" class="sa-input"
                           value="<?php echo e(old('last_name', $adminLastName)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sa-field">
                ...
                <input type="email" name="admin_email" class="sa-input"
                       value="<?php echo e(old('admin_email', $tenant->admin?->email ?? '')); ?>"
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;" class="sa-field">
    ...
    <div>
       ...
       value="<?php echo e($tenant->admin?->plain_password ?? ''); ?>"
       readonly
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/superadmin/tenants/edit.blade.php ENDPATH**/ ?>