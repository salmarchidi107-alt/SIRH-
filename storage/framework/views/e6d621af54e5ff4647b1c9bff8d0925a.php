...
<body>
    <div class="container">
        ...
        <div class="body">
            <div class="greeting">
                Bonjour <strong><?php echo e($absence->employee->full_name); ?></strong>,
            </div>
            ...
            <div class="info-card">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e(\App\Models\Absence::TYPES[$absence->type] ?? $absence->type); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">📆 Date de début</span>
                    <span class="info-value"><?php echo e($absence->start_date->format('d/m/Y')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">📆 Date de fin</span>
                    <span class="info-value"><?php echo e($absence->end_date->format('d/m/Y')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">⏱️ Nombre de jours</span>
                    <span class="info-value"><?php echo e($absence->days); ?> jour(s)</span>
                </div>
                <div class="info-row">
                    <span class="info-label">✅ Approuvé le</span>
                    <span class="info-value"><?php echo e($absence->approved_at ? $absence->approved_at->format('d/m/Y à H:i') : now()->format('d/m/Y à H:i')); ?></span>
                </div>
                <?php if($absence->replacement): ?>
                <div class="info-row">
                    <span class="info-label">🔄 Remplacé par</span>
                    <span class="info-value"><?php echo e($absence->replacement->full_name); ?></span>
                </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\HP\SIRH-\resources\views/emails/absence_approved.blade.php ENDPATH**/ ?>