...
<form action="<?php echo e(route('salary.copyPreviousMonth')); ?>" method="POST"
...
<?php if(session('errors_copy') && count(session('errors_copy')) > 0): ?>
<div class="alert alert-warning mb-4">
    <strong>Certains bulletins n'ont pas pu être copiés :</strong>
    <ul style="margin:6px 0 0 18px">
        <?php $__currentLoopData = session('errors_copy'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
