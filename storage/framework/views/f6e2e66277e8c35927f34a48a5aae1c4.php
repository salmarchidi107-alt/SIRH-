        ...
        <div id="client-list">
            <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
                    ...
                    data-tenant="<?php echo e(strtolower($client->tenant?->nom ?? '')); ?>"
                    onclick="selectClient(
                        <?php echo e($client->id); ?>,
                        '<?php echo e(addslashes($client->name)); ?>',
                        '<?php echo e(addslashes($client->email)); ?>',
                        '<?php echo e(addslashes($client->tenant?->subdomain ?? '')); ?>'
                    )"
                    role="button" tabindex="0"
                    onkeydown="if(event.key==='Enter') this.click()"
                >
                    <div class="sa-client-avatar sa-avatar-<?php echo e($index % 5); ?>">
                        <?php echo e(strtoupper(substr($client->name, 0, 2))); ?>

                    </div>
                    <div class="sa-client-info">
                        <div class="sa-client-name"><?php echo e($client->name); ?></div>
                        <div class="sa-client-email"><?php echo e($client->email); ?></div>
                    </div>
                    <div class="sa-client-meta">
                        <?php if($client->tenant): ?>
                            <span class="sa-chip-gray"><?php echo e($client->tenant->subdomain); ?></span>
                        <?php endif; ?>
                        <span class="sa-chip-<?php echo e(($client->statut ?? 'essai') === 'actif' ? 'green' : 'blue'); ?>">
                            <?php echo e(ucfirst($client->statut ?? 'essai')); ?>
                ...
                <div class="sa-form-grid">
                    <div class="sa-form-group">
                        ...
                        <input class="sa-input" type="email" id="field-email" name="email"
                            placeholder="ex: admin@societe.com" value="<?php echo e(old('email')); ?>" />
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\HospitalRh\resources\views/superadmin/settings/index.blade.php ENDPATH**/ ?>