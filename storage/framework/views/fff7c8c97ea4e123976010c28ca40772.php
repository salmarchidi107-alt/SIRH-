        ...
        <div class="sa-card-body">
            ...
            <div id="client-list">
                <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenantId => $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="sa-tenant-group" data-tenant-search="<?php echo e(strtolower($tenantName)); ?>">

                        <div class="sa-tenant-row">
                            <div class="sa-tenant-avatar" style="background: <?php echo e($avatarColor); ?>;"><?php echo e($initials); ?></div>
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="sa-user-row"
                                 ...
                                 data-role="<?php echo e(strtolower($roleLabel)); ?>"
                                 ...
                                 role="button"
                                 tabindex="0">
                                <div class="sa-user-avatar" style="background: <?php echo e($avatarColor); ?>;"><?php echo e($userInitials); ?></div>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Medstaff-second-main\resources\views/superadmin/settings/index.blade.php ENDPATH**/ ?>